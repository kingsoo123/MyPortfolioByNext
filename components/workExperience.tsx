...
function WorkExperience({}: Props) {
  const experiences = [
    ...
    },
    {
      ...
      endDate: " Oct 2022",
      description:
        "This FINTECH company has branches in Nigeria and UK. I work as a  Lead Developer (React) developer. Involved in building an online payment service for business merchants etc.",
      pics: airgate,
    },
  ];
  return (
